<x-app-layout>
        ...
        <!-- Contenido principal     -->
            <div class="col-span-2">
                ...
                <figure>
                    ...
                    @else
                    <img class="w-full h-80 object-cover object-center" src="https://cdn.pixabay.com/photo/2024/03/02/09/14/bridge-8608105_1280.jpg" alt="">
                    @endif
                </figure>
    ...
    <li class="mb-4">
        <a class="flex items-center space-x-3" href="{{ route('posts.show', $similar) }}">
            ...
            @else
            <img class="w-36 h-20 object-cover object-center" src="https://cdn.pixabay.com/photo/2024/03/02/09/14/bridge-8608105_1280.jpg" alt="">
            @endif
